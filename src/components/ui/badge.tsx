  ...
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        destructive: 'border-transparent bg-red-500 text-zinc-50 dark:bg-red-900 dark:text-red-50',
        outline: 'text-zinc-950 dark:text-zinc-50',
        success: 'border-transparent bg-emerald-500 text-white dark:bg-emerald-900 dark:text-emerald-50',
        warning: 'border-transparent bg-amber-500 text-white dark:bg-amber-900 dark:text-amber-50',
        info: 'border-transparent bg-blue-500 text-white dark:bg-blue-900 dark:text-blue-50',
      },
    },
    defaultVariants: {
      variant: 'default',
